...
def main():
    ...
    for svc in [SVC.SMS, SVC.VOIX, SVC.UNKNOWN, SVC.SVA, SVC.DATA, SVC.IMS]:
        ...
        if str(args.clients).find("new") != -1: # contains new clients
            ...
            prefix = "oba_telco_graph_indicators_newclients_of_" + args.edate + "_"
            ...
            prefix = "oba_telco_graph_indicators_"
            extract_and_copyfile(args, spark, td_driver, td_url, td_user, td_password, svc, sdate, edate, prefix)
